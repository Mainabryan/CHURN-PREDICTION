...
# Sidebar setup
st.sidebar.image('/content/openart-image_TEiYW09i_1768740498339_raw.png', use_column_width=True)
...
# App header
st.image('/content/openart-image_TEiYW09i_1768740498339_raw.png', use_column_width=True)
...
with right_col:
  ...
  if st.button('Predict'): # Added colon
    ...
    # Display results
    st.subheader(f'Predicted Value: {prediction_label}') # Corrected f-string
    ...
    st.markdown(f"**## Output: {prediction_label}**") # Corrected f-string and method